...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'aranha-rails', '~> 0.9', '>= 0.9.2'
  ...
  s.add_dependency 'eac_rails_gem_support', '~> 0.7', '>= 0.7.1'
  s.add_dependency 'eac_rails_remotes', '~> 0.1'
  s.add_dependency 'eac_rails_utils', '~> 0.20'
  ...
  s.add_dependency 'puma', '~> 5.6', '>= 5.6.6'
  s.add_dependency 'rails', '~> 5.2.8', '>= 5.2.8.1'
  s.add_dependency 'rails-i18n', '>= 5.1.3'
