...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'br_railties', '~> 0.6', '>= 0.6.1'
  ...
  s.add_dependency 'eac_cli', '~> 0.47'
  s.add_dependency 'eac_fs', '~> 0.20', '>= 0.20.2'
  s.add_dependency 'eac_rails_delayed_job', '~> 0.3', '>= 0.3.1'
  s.add_dependency 'eac_rails_gem_support', '~> 0.12', '>= 0.12.2'
  s.add_dependency 'eac_rails_remotes', '~> 0.5', '>= 0.5.2'
  s.add_dependency 'eac_rails_utils', '~> 0.29'
  s.add_dependency 'eac_ruby_utils', '~> 0.131', '>= 0.131.2'
  s.add_dependency 'eac_users_support', '~> 0.11', '>= 0.11.2'
