...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'aranha-parsers', '~> 0.26', '>= 0.26.3'
  s.add_dependency 'aranha-rails', '~> 0.11'
  s.add_dependency 'aranha-selenium', '~> 0.13', '>= 0.13.1'
  ...
  s.add_dependency 'eac_rails_gem_support', '~> 0.12', '>= 0.12.1'
  s.add_dependency 'eac_rails_remotes', '~> 0.5', '>= 0.5.1'
  s.add_dependency 'eac_rails_utils', '~> 0.28'
  s.add_dependency 'eac_ruby_utils', '~> 0.130'
  s.add_dependency 'eac_users_support', '~> 0.11', '>= 0.11.1'
  s.add_dependency 'fog-aws', '~> 3.33', '>= 3.33.1'
  ...
  s.add_dependency 'spring', '~> 4.4', '>= 4.4.2'
